...
## 🌱 What I Learned
- 프론트엔드 전반을 단독으로 책임지며 기획, 디자인, 개발, 배포까지 전 과정을 완주
- AI·컴퓨터 비전·헬스케어가 결합된 복합 시스템을 프론트엔드 관점에서 설계한 다학제적 개발 경험
- LangChain + GPT, FCM, PWA 등 최신 기술을 실제 서비스에 적용하며 빠른 기술 학습 및 문제 해결 능력 향상
- 연구 기반 문제 정의부터 구현, 결과 해석까지 이어지는 **연구형 프로젝트 사이클 경험**
